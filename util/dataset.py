...
class SemData(Dataset):
    def __init__(self, split=2, shot=1, normal=1, max_sp=5, data_root=None, data_list=None, nom_list=None, transform=None, mode='train',
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            return image, label,nom_s, s_x, s_y, subcls_list, raw_label, raw_img, raw_supp