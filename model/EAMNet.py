...
from model.dynamic_trans import DynamicTransformerLayer, GRN, RepConvBlock, SEModule
...
class OneModel(nn.Module):
    def __init__(self, args):
        ...
        self.dynamic = DynamicTransformerLayer(in_dim=reduce_dim, out_dim=reduce_dim, num_heads=args.num_heads)
        self.dynamic_deep = RepConvBlock(dim=reduce_dim*4)
        self.fpn = FPN(channel=reduce_dim)
        self.grn = GRN(dim=reduce_dim)
        self.se = SEModule(reduce_dim)
